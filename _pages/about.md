...
Linshuai Zhang is an Associate Professor and Master's Supervisor at Chengdu University of Traditional Chinese Medicine. He received his Ph.D. in Engineering from Kagawa University, Japan, under the supervision of Prof. Shuxiang Guo, Foreign Member of the Engineering Academy of Japan and IEEE Fellow. He is also a postdoctoral researcher and a high-level overseas returnee talent of Sichuan Province. His research focuses on vascular interventional surgical robots, continuum robots, force and tactile sensing, intelligent sensing and interactive control, and acupuncture robots.
<i class="fas fa-quote-right fa-2x fa-pull-right fa-border" aria-hidden="true"></i>
</p>

<ul class="quick-facts">
  <li><i class="fas fa-university"></i> Associate Professor / Master's Supervisor, Chengdu University of Traditional Chinese Medicine</li>
  <li><i class="fas fa-map-marker-alt"></i> Chengdu, Sichuan, China</li>
  <li><i class="fas fa-file-alt"></i> 40+ publications and 10 authorized Chinese patents</li>
</ul>
...
- Intelligent sensing and interactive control
- Acupuncture robots
...
- *2022* First Prize, "Green, Low-Carbon and New Materials" Preliminary Contest, Sichuan SME Innovation and Entrepreneurship Competition
- *2021* First Prize, university-level higher education teaching achievement award
- *2021* Third Prize, university-level higher education teaching achievement award
- *2021* Second Prize, the 10th university-level multimedia courseware competition
...
- *2017* Scholarship from the Kuraoka Scholarship Foundation, Japan
